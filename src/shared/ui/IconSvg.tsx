...
export const ArrowLeftIcon: React.FC<IconProps> = ({ size = 48, color = 'white' }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const SleepIcon: React.FC<IconProps> = ({ size = 48, color = 'white' }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill={color}
    width={size}
